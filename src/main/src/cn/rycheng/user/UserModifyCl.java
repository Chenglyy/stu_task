...
public class UserModifyCl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String sql="update "+tableName+" set ur_pwd=?,ur_type=?,ur_email=?,ur_phonelong=?,ur_phoneshort=?,"
				+ "ur_academy=?,ur_department=?,ur_major=?,ur_name=?,ur_principal=?,ur_power=? where ur_user=?;";
